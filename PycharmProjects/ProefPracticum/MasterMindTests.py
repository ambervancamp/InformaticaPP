...
# Self-made tests
assert get_nb_black_white_matches(["yellow", "yellow", "red", "blue"], ["white", "yellow", "red", "yellow"]) == (2, 1)
assert get_nb_black_white_matches(["white", "white", "white", "white"], ["blue", "white", "white", "red"]) == (2, 0)
...
#Self-made test
assert len(create_combination(4)) == 4
